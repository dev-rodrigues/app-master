...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.httpsantos.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"Esta API é utilizada no curso de Spring Boot por Carlos Henrique",
				"Versão 1.1",
				"https://github.com/httpsantos",
				new Contact(
						"Carlos Henrique",
						"https://github.com/httpsantos",
