...
import com.httpsantos.cursomc.domain.ItemPedido;
import com.httpsantos.cursomc.domain.Pagamento;
import com.httpsantos.cursomc.domain.PagamentoComBoleto;
import com.httpsantos.cursomc.domain.PagamentoComCartao;
import com.httpsantos.cursomc.domain.Pedido;
import com.httpsantos.cursomc.domain.Produto;
import com.httpsantos.cursomc.domain.enums.EstadoPagamento;
...
import com.httpsantos.cursomc.repositories.ItemPedidoRepository;
import com.httpsantos.cursomc.repositories.PagamentoRepository;
import com.httpsantos.cursomc.repositories.PedidoRepository;
import com.httpsantos.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "foda-se@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,
				enconder.encode("123"));

		Cliente cli2 = new Cliente(null, "Carlos Henrique", "carlos.hrq.rodrigues@gmail.com", "14897462770",
				TipoCliente.PESSOAFISICA, enconder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("24249033", "965861567"));
